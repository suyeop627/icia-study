...
public class ControllerClassDtoVer {
  //멤버로 스캐너 작성 (전체가 사용? ->찾아볼것)
  Scanner scan = new Scanner(System.in);
  //데이터 저장 공간(ArrayList) - Dto 배열 (DataDto)
  ArrayList<DataDto> datas = new ArrayList<>();   //데이터를 정리하는 거- 참조변용함 //길이를 지정하지 않아도 수 사무한히 담을수 있는 배열..? ->찾아볼것
  public void run(){
    ...
    void inputData(){
      ...
      //ArrayList에 값 추가 : add()
      //////////////////////////////////////////////
      //datas.add(num);    //push와 같은일을 하는 메소드 - 가장 뒤에 하나씩 넣어줌
/////////////////////////////////////////////////////////////
